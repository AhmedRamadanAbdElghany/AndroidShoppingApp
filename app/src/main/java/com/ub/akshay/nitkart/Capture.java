...
public class Capture extends AppCompatActivity { //implements BarcodeReader.BarcodeReaderListener {
...
/*
    ...
    public void onScanned(final Barcode barcode) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(getApplicationContext(), "Barcodeffffff: " + barcode.displayValue, Toast.LENGTH_SHORT).show();
            }
        });
    }
