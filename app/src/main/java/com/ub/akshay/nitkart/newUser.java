...
public class newUser extends AppCompatActivity {
    ...
    private String email, password, passwordVerification ,Saddress , Sphone;
    private EditText username, pass, passVerification, firstname, lastname , address , phone ;
...
*/
                        ...
                        myRef.child(user.getUid()).push(); // put id for the user .
                        ...
                        cart.add(new ShoppingItem("", "", "", "", -1, -1));
                         ...
                         cartItems.put("Favourites", cart);
                         cartItems.put("Username",name );
                         cartItems.put("Email",username.getText().toString());

                    myRef.setValue(cartItems);
...
//                            Toast.makeText(newUser.this, R.string.auth_failed, Toast.LENGTH_SHORT).show();
                            ...
                            Intent newI = new Intent(newUser.this,MainActivity.class);
                            startActivity(newI);
                            finish();
                        }
                    }
...
@Override
                    public void finish() {
                        ...
                        //+7 set email and pass after register in the openscreen
